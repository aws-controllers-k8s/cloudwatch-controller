...
func (in *CloudWatchConfig) DeepCopyInto(out *CloudWatchConfig) {
	*out = *in
	...
	if in.AlarmNamePrefix != nil {
		in, out := &in.AlarmNamePrefix, &out.AlarmNamePrefix
		*out = new(string)
		**out = **in
	}
	if in.Tags != nil {
...
func (in *PrometheusRuleStatus) DeepCopyInto(out *PrometheusRuleStatus) {
	*out = *in
	...
	if in.AlertingRuleCount != nil {
		in, out := &in.AlertingRuleCount, &out.AlertingRuleCount
		*out = new(int64)
		**out = **in
	}
	if in.SkippedRuleCount != nil {
		in, out := &in.SkippedRuleCount, &out.SkippedRuleCount
		*out = new(int64)
		**out = **in
	}
	if in.AlarmStatuses != nil {
		in, out := &in.AlarmStatuses, &out.AlarmStatuses
