...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForFirehoseARN(ctx, apiReader, ko); err != nil {
...
// identifier field.
func validateReferenceFields(ko *svcapitypes.MetricStream) error {

	if ko.Spec.FirehoseRef != nil && ko.Spec.FirehoseARN != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("FirehoseARN", "FirehoseRef")
	}
	if ko.Spec.FirehoseRef == nil && ko.Spec.FirehoseARN == nil {
		return ackerr.ResourceReferenceOrIDRequiredFor("FirehoseARN", "FirehoseRef")
	}
...
// resolveReferenceForFirehoseARN reads the resource referenced
// from FirehoseRef field and sets the FirehoseARN
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForFirehoseARN(
	ctx context.Context,
	apiReader client.Reader,
	ko *svcapitypes.MetricStream,
) (hasReferences bool, err error) {
	if ko.Spec.FirehoseRef != nil && ko.Spec.FirehoseRef.From != nil {
		hasReferences = true
		arr := ko.Spec.FirehoseRef.From
		if arr.Name == nil || *arr.Name == "" {
			return hasReferences, fmt.Errorf("provided resource reference is nil or empty: FirehoseRef")
		}
		...
		ko.Spec.FirehoseARN = (*string)(obj.Status.ACKResourceMetadata.ARN)
	}
