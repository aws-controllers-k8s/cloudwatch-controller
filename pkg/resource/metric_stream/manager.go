...
// +kubebuilder:rbac:groups=cloudwatch.services.k8s.aws,resources=metricstreams,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudwatch.services.k8s.aws,resources=metricstreams/status,verbs=get;update;patch
