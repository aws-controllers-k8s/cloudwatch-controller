...
const (
	FinalizerString = "finalizers.cloudwatch.services.k8s.aws/MetricStream"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("metricstreams")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.MetricStream{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.MetricStream),
	}
}
