...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.DashboardName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["dashboardName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: dashboardName"))
	}
	r.ko.Spec.DashboardName = &primaryKey
