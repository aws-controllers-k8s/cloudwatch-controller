...
const (
	FinalizerString = "finalizers.cloudwatch.services.k8s.aws/Dashboard"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("dashboards")
